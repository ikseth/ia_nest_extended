    ...
    Capability(
        ...
        (
            _param(
                "status",
                "string",
                "estado que se desea listar",
                choices=("activa", "archivada", "cerrada", "todas"),
                default="activa",
                metavar="ESTADO",
            ),
        ),
        _rest("session.list"),
        _cli("session", "list", "Lista las sesiones del usuario por estado."),
        _mcp("session.list"),
        "own",
    ),
    Capability(
        "session.new",
        "crea una sesion activa",
        True,
        False,
        (
            _param(
                "session_id",
                "string",
                "identificador elegido por el cliente; el servidor genera uno si se omite",
                metavar="ID",
            ),
        ),
        _rest("session.new"),
        _cli("session", "new", "Crea una sesion y la recuerda para la CLI."),
        _mcp("session.new"),
        "own",
    ),
    Capability(
        "session.show",
        "muestra una sesion del usuario",
        True,
        False,
        (
            _param(
        ...
        _rest("session.show"),
        _cli("session", "show", "Muestra estado y ciclo de vida de una sesion."),
        _mcp("session.show"),
        "own",
    ),
    Capability(
